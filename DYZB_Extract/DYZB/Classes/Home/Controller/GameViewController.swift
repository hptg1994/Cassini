...
private let kHeaderViewID2 = "kHeaderViewID"
private let kHeaderViewHeight2 : CGFloat = 50
private let kGameViewHeight2:CGFloat = 90
...
class GameViewController: UIViewController {
    ...
    fileprivate lazy var topHeaderView: CollectionHeaderView = {
        ...
        headerView.frame = CGRect(x: 0, y: -(kGameViewHeight2+kHeaderViewHeight2), width: kScreenWidth, height: kHeaderViewHeight2)
    ...
    fileprivate lazy var gameView: RecommendGameView = {
        ...
        gameView.frame = CGRect(x: 0, y: -kGameViewHeight2, width: kScreenWidth, height: kGameViewHeight2)
        return gameView
    }()
    ...
    fileprivate lazy var collectionView: UICollectionView = {[unowned self] in
        ...
        layout.headerReferenceSize = CGSize(width: kScreenWidth, height: kHeaderViewHeight2)
        //  11.8.1 如果要用这个头部，要先注册这个头部(直接用推荐页面的Header) --> 11.8.2 取header
        collectionView.register(UINib(nibName: "CollectionHeaderView", bundle: nil), forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: kHeaderViewID2 )
...
extension GameViewController {
    fileprivate func setupUI(){
        ...
        collectionView.contentInset = UIEdgeInsets(top: kGameViewHeight2+kHeaderViewHeight2, left: 0, bottom: 0, right: 0)
...
extension GameViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        // 1.取出HeaderView
        let headerView = collectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: kHeaderViewID2, for: indexPath) as! CollectionHeaderView
